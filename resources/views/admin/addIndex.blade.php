	...
	<div class="row-fluid sortable box-suco">
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon white edit"></i><span class="break"></span>Thêm chỉ số sức khỏe</h2>
				<div class="box-icon">
					<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
				</div>
			</div>
			<div class="box-content">
				<form class="form-horizontal" action="admin/index/add" method="POST" enctype="multipart/form-data">
					<input type="hidden" name="_token" value="{{csrf_token()}}">
					<div class="control-group">
						<label class="control-label">Tên chỉ số: </label>
						<div class="controls">
							<input type="text" name="txtIndex">
						</div>
					</div>
					<div class="control-group">
					...
					<div class="form-actions">
						...
						<button id="submit" type="submit" class="btn btn-primary">
							<div class="text-sendmail">Lưu</div>
						</button>
